...
class announcement extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->session->set_userdata('cl_page_title',tran('Announcement'));
    ...
    function index(){
        $data['fu_page_title']=tran("Manage Announcement");
        $this->load->admin_template('admin_side/announcement/index',$data);
    }

    function add(){

        $data['fu_page_title']=tran('Add new announcement');
        $this->load->admin_template('admin_side/announcement/add',$data);
    }
...
//this form for featured image 
    function featured_image(){
        ...
        $this->load->admin_template('admin_side/announcement/featured_image',$data);
    }
//function for uploading the featured image
    ...
    $this->load->library('upload',$config);
        ...
        $config['file_name'] = 'ansari-up.com-'.$name.$files_uploaded['file_ext'];
...
//this is the update form of data and also it loads image manager
	...
	function edit($id){
        ...
        $data['id']=$id;
        $this->load->admin_template('admin_side/announcement/edit',$data);	
	}
//this is the function of update form of data
    function update(){
      ...
      /*  $this->form_validation->set_rules('m_name' , null, 'alpha_numeric_spaces|required',
        ...
        if($this->form_validation->run()==false){
        $data['fu_page_title']="Edit article";
        $this->load->admin_template('admin_side/announcement/edit',$data);
        }else{
