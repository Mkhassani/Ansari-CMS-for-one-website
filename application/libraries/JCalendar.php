...
Class JCalendar{
	...
	private function ReturnMonthName($monname) {
		switch ($monname) {
			case 1:	return "حمل";	break; case 2:	return "ثور";	break; case 3:	return "جوزا";	break;
			case 4:	return "سرطان";	break; case 5:	return "اسد";	break; case 6:	return "سنبله";	break;
			case 7:	return "میزان";	break; case 8:	return "عقرب";	break; case 9:	return "قوس";	break;
			case 10:	return "جدی";	break; case 11:	return "دلو";	break; case 12:	return "حوت";	break;
		}
	}
	...
	public function greg_to_shamsi($date){
		if($date == "") return $date;
		$ar=explode('-', $date);
		$pd=$this->gregorian_to_jalali($ar[0],$ar[1],$ar[2]);
		$pd[1] = (strlen($pd[1])==2)? $pd[1]:"0".$pd[1];
		$pd[2] = (strlen($pd[2])==2)? $pd[2]:"0".$pd[2];
		$pdate=implode('/', $pd);
		return $pdate;
	}
	public function shamsi_to_greg($date){
		if($date == "") return $date;
		$ar=explode('/', $date);
		$pd=$this->jalali_to_gregorian($ar[0],$ar[1],$ar[2]);
		$gdate=implode('-', $pd);
		return $gdate;
	}
