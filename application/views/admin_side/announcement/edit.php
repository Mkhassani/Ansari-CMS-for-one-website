 ...
 <form action="<?php echo site_url('announcement/update'); ?>"  class="form-horizontal" method="post">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-body form">
                                ...
                                <div class="control-group <?php echo (form_error('m_summery') ) ? 'error' : ''; ?>">
									<label class="control-label"><?php tran('Summery');?> :<span class='red'>*</span></label>
									<div class="controls">
...
<?php if($this->uri->segment(2)!='update'){?>
	<div class="row-fluid" >
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo tran('Update Image');?></div>
								<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="javascript:;" class="remove"></a>
								</div>
							...
							<form action="<?php echo site_url('announcement/add_featured_image/update'); ?>" method="post" enctype="multipart/form-data">
