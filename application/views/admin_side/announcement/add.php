	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>admin_side/assets/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5<?php echo $this->session->userdata('admin_lang');?>.css" />
    	<!-- start of ajax body-->
		    <form action="<?php echo site_url('announcement/insert'); ?>"  class="form-horizontal" method="post">
				<div class="row-fluid">
					<div class="span12">
						<!-- BEGIN SAMPLE FORM PORTLET-->   
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo tran('Add New Announcement');?></div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                ...
                                <div class="control-group <?php echo (form_error('m_summery') ) ? 'error' : ''; ?>">
									...
									<div class="controls">
									<textarea class="span12 ckeditor m-wrap" rows="6" name="m_summery"><?php echo set_value('m_summery'); ?></textarea>
