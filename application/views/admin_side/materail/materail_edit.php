					...
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo tran('Manage product');?></div>
								<div class="tools">
	...
	<div class="row-fluid" >
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<form action="<?php echo site_url('materail/add_featured_image/update'); ?>" method="post" enctype="multipart/form-data">
