					...
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i><?php echo tran('Manage Product');?></div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="btn-group">
									<a href="<?php echo site_url('materail/add');?>" data-toggle="modal">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
									<?php $rows=$this->materail_model->get_where(array('m_category'=>'product'));;
									...
									?>
										...
										<tr  id="delete-hide-<?php echo $value->m_id;?>">
											...
											<?php switch ($value->m_type) {
												case 'p1':
													$category=tran('First Product');
													break;
												case 'p2':
													$category=tran('Second Product');
													break;
												case 'p3':
													$category=tran('Third Product');
													break;
												default:
													$category="";
													break;
											...
											<td><a  href="<?php echo site_url('materail/materail_edit/'.$value->m_id.'/'.$value->m_name) ?>" class="btn blue icn-only" id="edit"><i class="icon-share"></i></a></td>
