					...
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo tran('Plaese Upload Your Image');?> </div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                ...
                                <div class="wrap">
                                	...
                                	<form action="<?php echo site_url('user/crop_image/'.$id);?>" method="post" enctype="multipart/form-data">
