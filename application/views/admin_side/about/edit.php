 ...
 <form action="<?php echo site_url('about/update'); ?>"  class="form-horizontal" method="post">
					...
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo tran('Add new article for about');?></div>
								<div class="tools">
							...
							<div class="portlet-body form">
                                ...
                                <div class="control-group <?php echo (form_error('m_summery') ) ? 'error' : ''; ?>">
								 ...
								 <div class="control-group <?php echo (form_error('m_desc') ) ? 'error' : ''; ?>">
									<label class="control-label"><?php echo tran('Description');?> :<span class='red'>*</span></label>
									<div class="controls">
									<textarea class="span12 ckeditor m-wrap" rows="15" name="m_desc"><?php echo set_value('m_desc'); ?>
										<?php echo (isset($value->m_desc))? $value->m_desc : set_value('m_desc'); ?>
									</textarea>
	...
	<div class="row-fluid" >
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<form action="<?php echo site_url('about/add_featured_image/update'); ?>" method="post" enctype="multipart/form-data">
											...
											<a class="fancybox-button" data-rel="fancybox-button" title="Photo"
											 href="<?php  echo base_url();?>image/materail/<?php echo $id; ?>/<?php echo $file; ?>">
												<div class="zoom">
													...
													src="<?php  echo base_url();?>image/materail/<?php echo $id; ?>/thumb/<?php echo $file; ?>"  alt="Photo" />                    
