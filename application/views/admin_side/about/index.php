					...
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i><?php echo tran('Manage Article Of Abour Your Company');?></div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="btn-group">
									<a href="<?php echo site_url('about/add');?>" data-toggle="modal">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
									<?php $rows=$this->materail_model->get_where(array('m_category'=>'about'));
									...
									foreach ($rows as $key => $value) {?>
										...
										<tr  id="delete-hide-<?php echo $value->m_id;?>">
											...
											<td><a  href="<?php echo site_url('about/edit/'.$value->m_id.'/'.$value->m_name) ?>" class="btn blue icn-only" id="edit"><i class="icon-share"></i></a></td>
