 ...
 <form action="<?php echo site_url('materail/update'); ?>"  class="form-horizontal" method="post">
					...
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo tran('Update Gallery');?></div>
								<div class="tools">
...
<?php if($this->uri->segment(2)!='update'){?>
	...
	<div class="row-fluid" >
					<div class="span12">
						...
						<div class="portlet box purple">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i><?php echo tran('Update Images');?></div>
								<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="javascript:;" class="remove"></a>
								</div>
							...
							<form action="<?php echo site_url('photo_gallery/add_more_image/'); ?>" method="post" enctype="multipart/form-data">
										<input type="hidden" name="name" value="<?php echo $value->m_name?>">
