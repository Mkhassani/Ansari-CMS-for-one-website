                ...
                <div id="slider3_container" style="position: relative; top: 0px; left: 0px; width: 743px;
                    ...
                    <!-- Start Slides Container -->
                        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 743px; height: 356px; overflow: hidden;">
                            <?php
                                if($target_dir = opendir("image/materail/$id/thumb/")){
                                    while ($file = readdir($target_dir)) {
                                        if($file != "." && $file != ".."){  
                            ?>
                            <div>
                                <img u="image" src="<?php echo base_url();?>image/materail/<?php echo $id; ?>/<?php echo $file; ?>" />
                                <img u="thumb" src="<?php echo base_url();?>image/materail/<?php echo $id; ?>/thumb/<?php echo $file; ?>" />
                            </div>
                            <?php }}} ?>
                        </div>
