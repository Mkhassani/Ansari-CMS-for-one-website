        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Broozsoft IT Group',
                    // (string | mandatory) the text inside the notification
                    text: 'We Proud To Could Colleague To Reach Your Business Goals ',
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    position: 'top-left',
                    // (string | mandatory) the heading of the notification
                    title: 'Customise & Manage Your Website',
                    // (string | mandatory) the text inside the notification
                    text: 'The Easiest Way And Tools For Managing Your Website',
                    // (string | optional) the image to display on the left
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    title: 'Notification',
                    // (string | mandatory) the text inside the notification
                    text: 'You Can Ask Your Questions Freely',
                    // (string | optional) the image to display on the left
